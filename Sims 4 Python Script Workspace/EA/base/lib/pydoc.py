...
def visiblename(name, all=None, obj=None):
    if name in frozenset({'__credits__', '__spec__', '__path__', '__module__', '__file__', '__builtins__', '__slots__', '__date__', '__version__', '__loader__', '__name__', '__package__', '__cached__', '__author__', '__qualname__', '__doc__'}):
        return 0
