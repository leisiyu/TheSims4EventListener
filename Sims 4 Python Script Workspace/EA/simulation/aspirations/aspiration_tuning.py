...
class Aspiration(AspirationBasic):
    ...
    def _verify_tuning_callback(cls):
        for objective in cls.objectives:
            pass
        if cls.is_child_aspiration and cls.aspiration_valid_age_type != AspirationValidAgeType.CHILD_ONLY:
            logger.error('Tunable is_child_aspiration is deprecated, please make sure to update aspiration_valid_age_type to CHILD_ONLY for tuning {}', cls)
        if cls.is_teen_aspiration and cls.aspiration_valid_age_type != AspirationValidAgeType.TEEN_ONLY:
            logger.error('Tunable is_teen_aspiration is deprecated, please make sure to update aspiration_valid_age_type to TEEN for tuning {}', cls)
    ...
    def is_valid_for_sim(cls, sim_info):
        return sim_info.age & cls.aspiration_valid_age_type
